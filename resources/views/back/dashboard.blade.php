...
@section('title', 'Welcome to ' . __('info.title'))
...
<div class="col-md-8">
    ...
    <div class="col-md-6">
        ...
        <div class="box-body">
            ...
            <div class="direct-chat-msg">
                ...
                <!-- /.direct-chat-info -->
                <img class="direct-chat-img" src="{{asset('img/user-img.png')}}" alt="message user image">
                <!-- /.direct-chat-img -->
            ...
            <ul class="contacts-list">
                <li>
                <a href="#">
                    <img class="contacts-list-img" src="{{asset('img/user-img.png')}}" alt="User Image">
    ...
    <div class="col-md-6">
        ...
        <div class="box-body no-padding">
            ...
            <li>
                <img src="{{asset('img/user-img.png')}}" alt="User Image">
